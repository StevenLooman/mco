...
MetricSystem.KILOGRAM = new BaseUnit(Quantity.MASS, Prefix.KILO, 'g');
...
MetricSystem.LUX         = new AlternateUnit(Quantity.ILLUMINANCE, 'lx', MetricSystem.LUMEN.divide(MetricSystem.METRE).divide(MetricSystem.METRE));
MetricSystem.BECQUEREL   = new AlternateUnit(Quantity.RADIOACTIVE_ACTIVITY, 'Bq', ONE.divide(MetricSystem.SECOND));
MetricSystem.GRAY        = new AlternateUnit(Quantity.RADIATION_DOSE_ABSORBED, 'Gy', MetricSystem.JOULE.divide(MetricSystem.KILOGRAM));
MetricSystem.SIEVERT     = new AlternateUnit(Quantity.RADIATION_DOSE_EFFECTIVE, 'Sv', MetricSystem.JOULE.divide(MetricSystem.KILOGRAM));
MetricSystem.KATAL       = new AlternateUnit(Quantity.CATALYTIC_ACTIVITY, 'kat', MetricSystem.MOLE.divide(MetricSystem.SECOND));
